...
namespace SmallSung\BlockChainManage\BlockChain\Instances\Erc20;
...
class Usdt extends Erc20Abstract
{
    ...
    {
        $event = new EthContractEventTransferConfig();
        $event->setEventName('Transfer(address,address,uint256)');
        $event->setFromIndex(1);
        $event->setToIndex(2);
        $event->setValueIndex(3);
        return $event;
    }
    ...
    {
        $function = new EthContractFunctionTransferConfig();
        $function->setFunctionName('transfer(address,uint256)');
        $function->setToIndex(0);
        $function->setValueIndex(1);
        return $function;
    }
